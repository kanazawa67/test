package com.internoudev.webproj5.action;
...
import com.internoudev.webproj5.dao.InquiryCompleteDAO;
import com.internoudev.webproj5.dto.InquiryDTO;
...
public class InquiryCompleteAction extends ActionSupport implements SessionAware{
	...
	public Map<String, Object> getSecction(){
		return session;
	}
